...
- It is not a betting product. Modeling inputs — team ratings, player impact, projected minutes, injury statuses, and model weights — remain manual configuration; the model itself does not consume live data at runtime. The pooled reconstruction covers 360 playoff series and 2,014 pregame states (2003–2026), including era-correct Finals home patterns. Rolling-origin evaluation covers 1,760 games and 315 series (2006–2026). The separately scored 2026 holdout covers 85 games and 15 series; both challenger registrations are `CONTAMINATED_2026`. Historical availability coverage is zero and injury effects are not claimed. See docs/backtest/methodology.md and docs/claims-ledger.md. It is not calibrated against external benchmarks or production-grade for unsupervised public use.
