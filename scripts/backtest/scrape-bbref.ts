...
export const SEASONS = [2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025] as const;
...
export function parseTeamRatings(html: string, season: number): RawTeamRating[] {
  ...
  if (ratings.length !== 30) {
    throw new Error(`Expected 30 team ratings for ${season}, parsed ${ratings.length}.`);
  }
